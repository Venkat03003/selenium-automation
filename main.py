...
driver.get("https://people.zoho.in/httpswwwicaniocom/zp#home/dashboard")
# Add cookies
# cookies = [
...
sign_in_button=driver.find_elements(By.XPATH,"/html/body/header/div[2]/div[1]/div/div[3]/div[3]/a[1]")
...
google_button=driver.find_elements(By.XPATH,"//*[@id='signin_div']/div[5]/span[1]/div/span[2]")
...
print(input)
input[0].send_keys("youremail@gmail.com")
